		...
		<div class="card-body">
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							<label for="" class="control-label">שם פרטי</label>
							<input type="text" name="firstname" class="form-control form-control-sm" required value="<?php echo isset($firstname) ? $firstname : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">שם משפחה</label>
							<input type="text" name="lastname" class="form-control form-control-sm" required value="<?php echo isset($lastname) ? $lastname : '' ?>">
						</div>
						<?php if($_SESSION['login_type'] == 1): ?>
						<div class="form-group">
							<label for="" class="control-label">הרשאות</label>
						...
						<?php endif; ?>
						<div class="form-group">
							<label for="" class="control-label">תמונה</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="label control-label">אשר סיסמא</label>
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					<button class="btn btn-primary mr-2">שמירה</button>
					<button class="btn btn-secondary mr-2" type="button" onclick="location.href = 'index.php?page=user_list'">ביטול</button>
				</div>
			</form>
		</div>
	</div>
